...
<main>
  ...
  <section class="part two">
    ...
    <p>The USWDS compiler uses a task runner called <a href="https://gulpjs.com">Gulp</a> to run its scripts and functions. You'll need what's called a "gulpfile" to tell the USWDS compiler how you'd like to use it.</p>
    <div class="terminal">
      <pre>touch gulpfile.js</pre>
    </div>
    <h3 class="step">In the new gulpfile you just created, import the USWDS compiler package.</h3>
    <p>This connects your gulpfile to USWDS compiler's <a href="https://github.com/uswds/uswds-gulp/tree/jm-gulp-4#functions">settings and functions</a>.</p>
    <div class="editor">
...
exports.compile = uswds.compile;</pre>
  ...
  <section class="part three">
    ...
    <h3 class="step">Install the USWDS compiler package.</h3>
    <div class="terminal">
      <pre>npm install @uswds/compile --save</pre>
    </div>
  </section>
</main>
<footer>
